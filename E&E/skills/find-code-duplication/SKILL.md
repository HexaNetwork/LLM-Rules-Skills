...
**UI:** Before proposing a new shared component, search `src/features/dev/components/KitchenSinkPage.tsx` for an existing pattern.
...
- Check `KitchenSinkPage` before introducing shared UI.
